                ...
                <div class="mec-container">
                    ...
                    <form id="mec_notifications_form">
                        ...
                        <div id="notification_options" class="mec-options-fields active">
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_settings_attach_default_invoice_confirmation"><?php esc_html_e('Attach default invoice to confirmation email', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    <select id="mec_settings_attach_default_invoice_confirmation" name="mec[settings][attach_default_invoice_confirmation]">
                                        <option value="1" <?php echo (!isset($settings['attach_default_invoice_confirmation']) || (string)$settings['attach_default_invoice_confirmation'] === '1') ? 'selected="selected"' : ''; ?>><?php esc_html_e('Yes', 'mec'); ?></option>
                                        <option value="0" <?php echo (isset($settings['attach_default_invoice_confirmation']) && (string)$settings['attach_default_invoice_confirmation'] === '0') ? 'selected="selected"' : ''; ?>><?php esc_html_e('No', 'mec'); ?></option>
                                    </select>
                                    <p class="description"><?php esc_html_e('If enabled, MEC attaches the default invoice PDF to booking confirmation emails. Disable to prevent duplicate invoices when using the Ticket & Invoice add-on.', 'mec'); ?></p>
                                </div>
                            </div>
