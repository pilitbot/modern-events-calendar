                    ...
                    <form id="mec_modules_form">
                        ...
                        <div id="countdown_option" class="mec-options-fields">
                            ...
                            <div id="mec_count_down_container_toggle" class="<?php if((isset($settings['countdown_status']) and !$settings['countdown_status']) or !isset($settings['countdown_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_countdown_method"><?php esc_html_e('Countdown Method', 'mec'); ?></label>
                                    <div class="mec-col-9">
                                        <select id="mec_settings_countdown_method" name="mec[settings][countdown_method]">
                                            <option value="start" <?php echo $countdown_method === 'start' ? 'selected="selected"' : ''; ?>><?php esc_html_e('Count to Event Start', 'mec'); ?></option>
                                            <option value="end" <?php echo $countdown_method === 'end' ? 'selected="selected"' : ''; ?>><?php esc_html_e('Count to Event End', 'mec'); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mec-form-row">
