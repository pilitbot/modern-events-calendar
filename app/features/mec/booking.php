                                ...
                                <div class="mec-form-row">
                                    <div class="form-col-12">
                                        <label>
                                            ...
                                            <input value="1" type="checkbox" name="mec[settings][appointments_display_in_shortcodes]" <?php if(isset($settings['appointments_display_in_shortcodes']) && $settings['appointments_display_in_shortcodes']) echo 'checked="checked"'; ?> /><?php esc_html_e('Display appointment slots in shortcodes', 'mec'); ?>
                                        </label>
                                        <p><?php esc_html_e('If enabled, appointments are marked as public on save, so they can appear in MEC shortcodes.', 'mec'); ?></p>
                                    </div>
                                </div>
