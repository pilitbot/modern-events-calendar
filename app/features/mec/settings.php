            ...
            <div class="wns-be-group-tab">
                <div class="mec-container">
                    ...
                    <form id="mec_settings_form">
                        ...
                        <h4 class="mec-form-subtitle"><?php esc_html_e('Search', 'mec'); ?></h4>
                            ...
                            <div class="mec-basvanced-basic">
                                <h5 class="mec-form-subtitle"><?php esc_html_e('Search Bar', 'mec'); ?></h5>
                            ...
                            <div class="mec-basvanced-advanced w-hidden">
                                ...
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input value="1" type="checkbox" name="mec[settings][sf_update_url]" <?php if(isset($settings['sf_update_url']) && $settings['sf_update_url']) echo 'checked="checked"'; ?> /><?php esc_html_e('Update browser URL with active filters', 'mec'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box">
                                            <h5 class="title"><?php esc_html_e('URL Sync', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('When enabled, applying filters updates the page URL with query parameters so the filtered view can be shared or bookmarked. Resetting filters restores the original URL.', 'mec'); ?></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                                <h5 class="mec-form-subtitle"><?php esc_html_e('Geo-point', 'mec'); ?></h5>
                                <div class="mec-form-row">
                                    <label class="mec-col-3" for="mec_settings_google_geocoding_api_key"><?php esc_html_e('Google Geocoding API Key', 'mec'); ?></label>
                                    <div class="mec-col-9">
