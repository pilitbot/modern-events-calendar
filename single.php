                                ...
                                <div class="mec-form-row">
                                    ...
                                    <div class="mec-col-9">
                                        ...
                                        <select id="mec_settings_single_event_single_style" name="mec[settings][single_single_style]">
                                            <option value="default" <?php echo ($single_style_value == 'default') ? 'selected="selected"' : ''; ?>><?php esc_html_e('Default Style', 'mec'); ?></option>
                                            <option value="modern" <?php echo ($single_style_value == 'modern') ? 'selected="selected"' : ''; ?>><?php esc_html_e('Modern Style', 'mec'); ?></option>
                                            <?php do_action('mec_single_style', $settings); ?>
                                            <?php if(is_plugin_active( 'mec-single-builder/mec-single-builder.php')): ?>
                                            <option value="builder" <?php echo ($single_style_value == 'builder') ? 'selected="selected"' : ''; ?>><?php esc_html_e('Elementor Single Builder', 'mec'); ?></option>
                                            <?php endif; ?>
                                            <?php if(is_plugin_active( 'mec-gutenberg-single-builder/mec-gutenberg-single-builder.php')): ?>
                                            <option value="gsb-builder" <?php echo ($single_style_value == 'gsb-builder') ? 'selected="selected"' : ''; ?>><?php esc_html_e('Gutenberg Single Builder', 'mec'); ?></option>
                                            <?php endif; ?>
                                        </select>
                                        <span class="mec-tooltip">
                                            <div class="box left">
